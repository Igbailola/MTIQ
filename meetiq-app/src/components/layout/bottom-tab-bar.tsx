...
export function BottomTabBar() {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-40 border-t border-meetiq-border/50 bg-white px-2 py-1 md:hidden flex items-center justify-around h-14 pb-safe">
      ...
      <div className="relative -top-4 mx-2">
        <Button
          ...
          size="icon"
          className="h-12 w-12 rounded-full bg-accent text-white shadow-meetiq-md shadow-blue-500/20 hover:bg-blue-600 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2"
        >
      ...
      <Sheet open={drawerOpen} onOpenChange={setDrawerOpen}>
        ...
        <SheetContent side="bottom" className="rounded-t-2xl p-6">
          ...
          <div className="flex flex-col gap-2 pt-4">
            <Button
              variant="ghost"
              className="justify-start text-slate-700 h-11 text-sm font-medium gap-3"
              onClick={() => {
                setDrawerOpen(false);
                router.push('/team');
              }}
